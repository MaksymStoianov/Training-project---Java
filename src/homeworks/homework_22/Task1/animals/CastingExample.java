package homeworks.homework_22.Task1.animals;
 ...
 */
    ...
    for (int i = 0; i < animals.length; i++) {
      ...
      System.out.println(animals[i].getClass() + " instanceof Cat: " +
                         (animals[i] instanceof Cat)); // проверяем, что ссылка может быть приведена к типу Cat
