...
public class StringUtil {
  ...
  /**
   * Возвращает {@code Map<String, Integer>}, где каждому слову соответствует количество его вхождений в тексте.
   * Сохраняет порядок.
   *
   * @param input Строка.
  ...
  /**
   * Возвращает {@code Map<Character, Integer>}, где каждому символу соответствует количество его вхождений в тексте.
   * Сортирует в натуральном порядке.
   *
   * @param input Строка.
   * @return {@code Map<Character, Integer>}
   */
  public static Map<Character, Integer> getCharCounts(String input) {
    // TreeMap, натуральная сортировка.
    Map<java.lang.Character, java.lang.Integer> map = new TreeMap<>(Comparator.naturalOrder());

    // Считаем количество вхождений.
    for (java.lang.Character item : input.toCharArray()) {
